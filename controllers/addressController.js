...
const Address = require("../models/Address"); // Corrected import
...
module.exports = {
  addAddress: async (req, res) => {
    const newAddress = new Address({
      ...
      deliveryInstructions: req.body.deliveryInstructions, // Corrected field name
  ...
  getAddresses: async (req, res) => {
    try {
      const addresses = await Address.find({ userId: req.user.id }); // Corrected variable name
